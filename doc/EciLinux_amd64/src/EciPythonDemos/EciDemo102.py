...
from ECI102 import *  # @UnusedWildImport
...
class EciDemo102:
    ...
    def RunDemo(self):
        ...
        stcHwPara.wHardwareClass = ECI_HW_ISA
        if ECIDEMO_HWUSEPOLLINGMODE:
            stcHwPara.dwFlags = ECI_SETTINGS_FLAG_POLLING_MODE
        else:
            stcHwPara.u.sIsaSettings.dwVer            = ECI_STRUCT_VERSION_V0;
            stcHwPara.u.sIsaSettings.u.V0.dwAddress   = 0x0000;                # TODO: Enter ISA Address here
            stcHwPara.u.sIsaSettings.u.V0.bInterrupt  = 0;                     # TODO: Enter ISA Interrupt here
        ...
        print ("-> Returning from ECI Demo for iPC-I 320 / ISA (104) <-\n")
